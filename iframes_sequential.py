...
# Loop to run the main function multiple times with a delay in between
for iteration in range(num_iterations):
    print(f"Starting iteration {iteration + 1} of {num_iterations}")
    main()
    # Wait for 10 minutes before the next iteration unless it's the last one.
    if iteration < num_iterations - 1:
        print(f"Waiting 10 minutes before the next iteration...")
